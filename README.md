...
This software is provided as a compiled binary for end-use only. No source code is included or authorized for release. Unauthorized modification, redistribution, or reverse engineering of the binary is strictly prohibited.
