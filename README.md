...
AxisCLI is a standalone command-line interface for Windows designed to simplify everyday system interaction.  
It combines navigation, system control, and access to native Windows tools into a single, consistent environment.

The goal of AxisCLI is not to replace existing shells like CMD or PowerShell, but to provide a more direct and structured way to perform common tasks.
...
- Does not replace CMD or PowerShell  
